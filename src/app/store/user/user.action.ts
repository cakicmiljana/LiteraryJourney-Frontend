...
export const completeBookSuccess = createAction('Complete Book', props<{userId: string, book: Book}>());
export const completeTheme = createAction('Complete Theme', props<{userId: string, theme: Theme}>());
export const completeThemeSuccess = createAction('Complete Theme', props<{userId: string, theme: Theme}>());
...
export const getCompletedThemesSuccess = createAction('Get Completed Themes', props<{themes: Theme[]}>());